...
var TemplateCompiler = (function () {
    ...
    TemplateCompiler.prototype.compileTemplatesCodeGen = function (components) {
        ...
        collection_1.ListWrapper.forEachWithIndex(componentMetas, function (compMeta, index) {
            ...
            var compiledTemplateExpr = "new " + command_compiler_1.TEMPLATE_COMMANDS_MODULE_REF + "CompiledTemplate(" + command_compiler_1.TEMPLATE_COMMANDS_MODULE_REF + "nextTemplateId()," + templateDataFn + ")";
            ...
            if (compMeta.type.isHost) {
                ...
                variableValueExpr =
                    constructionKeyword + " " + command_compiler_1.TEMPLATE_COMMANDS_MODULE_REF + "CompiledHostTemplate(" + factoryName + ")";
            }
            else {
